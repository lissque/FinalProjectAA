...
public class Encuesta extends JFrame implements ActionListener {
	...
	public Encuesta(Home home) {
		...
		JLabel lblText = new JLabel(
				"Responda la siguiente encuesta teniendo en cuenta la escala linkert.s permite medir actitudes y conocer el grado de conformidad del encuestado con cualquier afirmaci\u00F3n que le propongamos.");
		...
		JLabel lblYConocerEl = new JLabel(
				" y conocer el grado de conformidad del encuestado con cualquier afirmaci\u00F3n que le propongamos.");
